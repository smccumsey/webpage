...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title>Page not found: PythonAnywhere</title>
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <meta name="description" content="Page not found: PythonAnywhere">
        ...
        <!-- Le styles -->
        <link rel="stylesheet" href="/static/CACHE/css/c6cdbc54108f.css" type="text/css" media="screen" />
        <link rel="stylesheet" href="/static/CACHE/css/2490bb96ecdd.css" type="text/css" media="screen" />

        <!-- Le javascript -->
        <script type="text/javascript">
            var Anywhere = {};
            Anywhere.urls = {};
            Anywhere.csrfToken = "2aZRgbCr4r5UYwOeHf9GAiznJE56t2zs";
        </script>
        <script type="text/javascript" src="/static/CACHE/js/604ec006f963.js"></script>
                ...
                <div class="row">
                    <ul id="id_header_links" class="nav navbar-nav navbar-right ">
                        ...
                        <li><a href="http://blog.pythonanywhere.com/" id="id_blog_link">Blog</a></li>
                            ...
                            <li><a href="/user/smccumsey/" id="id_dashboard_nav_link">Dashboard</a></li>
                            <li><a href="/user/smccumsey/account/" id="id_account_link">Account</a></li>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2">
                ...
                <h1 class="error_header" id="id_server_error_title">404 Not Found</h1>
